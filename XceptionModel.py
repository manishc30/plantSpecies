...
loadFeaturesOfTrainData = True # set True to load features from npy file
...
loadFeaturesOfTestData = True # set True to load features from npy file

# augmented images
useAugmentedData = False # set True to use augmented images
loadFeaturesOfAugData = True # set True to load features from file for augmented data
...
test_df[['file', 'species']].to_csv('TestImages.csv', index=False)
